const faqs = [
  {
    ...
    answer: "Yes, the app is fully functional on both mobile and desktop devices."
  },
  {
    question: "Why did you create this app if one already exists on Table Top Simulator?",
    answer: "In short: we wanted to have a mobile interface, be able to automate everything, have no ambiguity in rules implementation, and be able to play both in real time and through correspondence. The app requires no external scripting or downloads. 100% browser based and it does everything for you. All you have to do is play."
  },
  {
  ...
  {
    question: "Where can I contact you to report an issue, give feedback, etc?",
    answer: "You can contact us at twanelapp@gmail.com"
  }
];
